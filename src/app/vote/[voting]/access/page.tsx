    ...
    <main className="mx-auto flex min-h-screen w-full max-w-sm flex-col justify-center px-5 py-10">
      <header className="mb-6 text-center">
        ...
        <p className="mt-2 text-sm text-muted">
          {isPublic
            ? `Ordena los equipos como prefieras y pulsa "Enviar Ranking". No es necesario que compartas la captura de pantalla con ${voting.name}, tu ranking quedará guardado automáticamente en la base de datos.`
